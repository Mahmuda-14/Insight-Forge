  ...
  return (
   ...
   <div>
    ...
    <Image src="https://i.ibb.co/wWQfKSr/Untitled-design-1-removebg-preview.png" alt='ok' width={200} height={200}></Image>
     ...
     <div className='grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-1 justify-around items-center my-[150px]  bg-[#87CEEB] lg:h-[350px] md:h-[800px] sm:h-[800px]'>
      <div className=" w-[200px] bg-white p-8 rounded shadow-2xl mt-8 ml-[20px]">
    ...
    <div className=" w-[200px] flex items-center justify-center bg-white p-8 rounded shadow-2xl mt-8 ml-[20px]">
