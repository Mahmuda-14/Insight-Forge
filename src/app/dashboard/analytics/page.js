...
// import { BarChart, Bar, Cell, XAxis, YAxis, CartesianGrid, ResponsiveContainer, Legend, PieChart, Pie } from 'recharts';
...
//         return { name: data.name, value: data.uv }
//     })
...
//     return (
//         // <div style={{ width: '100%', height: '76%', marginTop: '121px' }}>
...
//                     <div className="stat-value">hello</div>
